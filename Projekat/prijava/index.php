...
<h1>Prijava - Kreiranje naloga </h1>



<form name="logovanje" action="login.php" method="post">

 <p><input type="submit" value="PRIJAVITE SE"></p> <!--align="right"      align="center"  -->

 </form>

 <form name="logovanje" action="login1.php" method="post">

 <input type="submit" value="NOVI NALOG">
