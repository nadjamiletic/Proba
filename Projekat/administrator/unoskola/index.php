...
<br />
	...
	<table id="tt" class="easyui-datagrid" style="width:1000px;height:680px"
		...
		<thead>
			<tr>
				...
				<th field="registracija" width="0" sortable="true">Registracija</th>
				<th field="brojsedista" width="0" sortable="true">Broj sedista</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:580px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<input name="registracija" class="easyui-textbox" required="true">
			...
			<input name="brojsedista" class="easyui-textbox" required="true">
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = 'update_user.php?kolaid='+row.kolaid;
			}
		}
		function saveUser(){
