...
<ul id="menu">
	...
	<div class="demo-info" style="margin-bottom:10px">
		...
		<center><h2>UNOS VRSTE LINIJE</h2></center>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:580px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				...
				<input name="nazivvl" class="easyui-textbox" required="true">
			</div>
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				...
				url = 'update_user.php?vrstalinijeid='+row.vrstalinijeid;
			}
		}
		function saveUser(){
