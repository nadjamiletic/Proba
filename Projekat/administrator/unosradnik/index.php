...
<ul id="menu">
	...
	<div class="demo-info" style="margin-bottom:10px">
		...
		<center><h2>UNOS RADNIKA</h2></center>
	...
	<table id="tt" class="easyui-datagrid" style="width:1000px;height:680px"
		...
		<thead>
			<tr>
				...
				<th field="ime" width="0" sortable="true">Ime</th>
				<th field="prezime" width="0" sortable="true">Prezime</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:580px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<input name="ime" class="easyui-textbox" required="true">
			...
			<input name="prezime" class="easyui-textbox" required="true">
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				...
				url = 'update_user.php?radnikid='+row.radnikid;
			}
		}
		function saveUser(){
