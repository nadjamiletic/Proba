...
<ul id="menu">
	...
	<div class="demo-info" style="margin-bottom:10px">
		...
		<center><h2>UNOS MESTA</h2></center>
	...
	<table id="tt" class="easyui-datagrid" style="width:1000px;height:680px"
		...
		<thead>
			<tr>
			    ...
			    <th field="nazivm" width="0" sortable="true">Naziv mesta</th>
				<th field="nazivd" width="0" sortable="true">Naziv drzave</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:580px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label> Mesto</label>
				<input name="nazivm" class="easyui-textbox" required="true">
			</div>
			...
			<div class="fitem">
				...
				$stmt = $dbh->prepare('select drzavaid,nazivd from drzava group by drzavaid');
				...
				<label>Drzava:</label>
				<select class="easyui-combobox" required="true" name="drzavaid" style="width:200px;">
				
                <?php foreach ($data as $row): ?>
				<option><?=$row["drzavaid"]?>.<?=$row["nazivd"]?></option>
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				...
				url = 'update_user.php?mestoid='+row.mestoid;
			}
		}
		function saveUser(){
