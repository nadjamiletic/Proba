...
<br />
		...
		<center><h2>UNOS DATUMA POLASKA</h2></center>
	...
	<table id="tt" class="easyui-datagrid" style="width:1000px;height:680px"
		...
		<thead>
			...
			<tr>
				...
				<th field="datumpolaskaid" width="0" sortable="true">ID</th>

				<th field="datum" width="0" sortable="true">Datum</th>

			    <th field="oznakap" width="0" sortable="true">Polazak</th>

				<th field="registracija" width="0" sortable="true">Kola</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:580px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
				...
				<input name="datum" class="easyui-textbox" required="true">
			...
			<div class="fitem">
				...
				$stmt = $dbh->prepare('select polazakid,oznakap from polazak group by polazakid');
				...
				<select class="easyui-combobox" required="true" name="polazakid" style="width:200px;">

				

                <?php foreach ($data as $row): ?>

				<option><?=$row["polazakid"]?>.<?=$row["oznakap"]?></option>
			...
			<div class="fitem">
				...
				<select class="easyui-combobox" required="true" name="kolaid" style="width:200px;">

				

                <?php foreach ($data as $row): ?>

				<option><?=$row["kolaid"]?>.<?=$row["registracija"]?></option>
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				...
				url = 'update_user.php?datumpolaskaid='+row.datumpolaskaid;
