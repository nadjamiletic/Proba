...
<ul id="menu">
	...
	<div class="demo-info" style="margin-bottom:10px">
		...
		<center><h2>UNOS STANICA</h2></center>
	...
	<table id="tt" class="easyui-datagrid" style="width:1000px;height:680px"
		...
		<thead>
			<tr>
			    <th field="imes" width="0" sortable="true">Ime Stanice</th>
				 <th field="adresas" width="0" sortable="true">Adresa Stanice</th>
				<th field="lat" width="0" sortable="true">Latituda Stanice</th>
				<th field="lng" width="0" sortable="true">Longituda Stanice</th>
				<th field="tip" width="0" sortable="true">Tip Stanice</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:580px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label> Stanica</label>
				<input name="imes" class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label> Adresa Stanice</label>
				<input name="adresas" class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label> Latituda Stanice</label>
				<input name="lat" class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label> Longituda Stanice</label>
				<input name="lng" class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label> Tip Stanice</label>
				<input name="tip" class="easyui-textbox" required="true">
			</div>
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				...
				url = 'update_user.php?stanicaid='+row.stanicaid;
			}
		}
		function saveUser(){
